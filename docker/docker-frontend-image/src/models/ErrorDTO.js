 ...
 */
export function instanceOfErrorDTO(value) {
    if (!("code" in value) || value["code"] === undefined)
        return false;
    return true;
}
export function ErrorDTOFromJSON(json) {
    return ErrorDTOFromJSONTyped(json, false);
}
export function ErrorDTOFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function ErrorDTOToJSON(json) {
    return ErrorDTOToJSONTyped(json, false);
}
export function ErrorDTOToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
