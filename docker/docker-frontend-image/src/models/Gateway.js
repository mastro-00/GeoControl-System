 ...
 */
import { SensorFromJSON, SensorToJSON, } from './Sensor';
/**
 * Check if a given object implements the Gateway interface.
 */
export function instanceOfGateway(value) {
    return true;
}
export function GatewayFromJSON(json) {
    return GatewayFromJSONTyped(json, false);
}
export function GatewayFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        ...
        'sensors': json['sensors'] == null ? undefined : (json['sensors'].map(SensorFromJSON)),
    };
}
export function GatewayToJSON(json) {
    return GatewayToJSONTyped(json, false);
}
export function GatewayToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
        ...
        'sensors': value['sensors'] == null ? undefined : (value['sensors'].map(SensorToJSON)),
    };
}
