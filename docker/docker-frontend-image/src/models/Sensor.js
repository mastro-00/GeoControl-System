 ...
 */
export function instanceOfSensor(value) {
    return true;
}
export function SensorFromJSON(json) {
    return SensorFromJSONTyped(json, false);
}
export function SensorFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SensorToJSON(json) {
    return SensorToJSONTyped(json, false);
}
export function SensorToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
