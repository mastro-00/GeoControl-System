...
import { StatsFromJSON, StatsToJSON, } from './Stats';
/**
 * Check if a given object implements the Measurements interface.
 */
export function instanceOfMeasurements(value) {
    if (!('sensorMacAddress' in value) || value['sensorMacAddress'] === undefined)
        return false;
    return true;
}
export function MeasurementsFromJSON(json) {
    return MeasurementsFromJSONTyped(json, false);
}
export function MeasurementsFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        ...
        'measurements': json['measurements'] == null ? undefined : (json['measurements'].map(MeasurementFromJSON)),
    };
}
export function MeasurementsToJSON(json) {
    return MeasurementsToJSONTyped(json, false);
}
export function MeasurementsToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
        ...
        'measurements': value['measurements'] == null ? undefined : (value['measurements'].map(MeasurementToJSON)),
    };
}
